...
class Products(models.Model):
    ...
    order_number = models.IntegerField(null=False, verbose_name='Номер заказа')
    ...
    price = models.DecimalField(decimal_places=3, max_digits=50, null=False, verbose_name='Цена')
